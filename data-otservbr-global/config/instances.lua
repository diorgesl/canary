...
-- The maps should be placed in the data-otservbr-global/world/custom directory
...
InstanceMaps = {
    -- Player hideout
    ["hideout"] = {
        mapFile = "data-otservbr-global/world/custom/hideout.xml",
    ...
    -- Hunting grounds
    ["hunting_grounds"] = {
        mapFile = "data-otservbr-global/world/custom/hunting_grounds.xml",
    ...
    ["beginner"] = {
        mapFile = "data-otservbr-global/world/custom/hunting_grounds.xml", -- Using the same map for now
...
dofile('data-otservbr-global/scripts/instances/instance_manager.lua')